...
const Register = () => {
  return (
    <main className="w-full max-w-md mx-auto p-6 py-[100px]">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    id="email"
                    name="email"
                    className="py-3 px-4 block w-full border-gray-700 border rounded-lg text-sm  disabled:opacity-50 disabled:pointer-events-none "
                    required=""
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    id="password"
                    name="password"
                    className="py-3 px-4 block w-full  rounded-lg text-sm border-gray-700 border disabled:opacity-50 disabled:pointer-events-none "
                    required=""
